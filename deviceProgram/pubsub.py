...
# python3 pubsub.py --endpoint <iotcoreendpoint> --ca_file <\AmazonRootCA1.pem> --cert <certificate.pem.crt file> --key <private.pem.key file> --topic device/{deviceID}/data --count 1 
# Parse arguments
...
if __name__ == '__main__':
    ...
    print("raw input {} ".format(message_string))
    
    epoch_time = int(time.time())
    
    #Parking data retrieved from sensor. Code to retrieve data from hardware not shown
    developer_Dict = {
	"timestamp": epoch_time,
	"isOccupied": True,
	"meter": {
		"number": 4,
		"location": [ "-87.716", "-176.5731"],
		"address": "253 Johnson Creek, XYZ, AB"
	},
    "deviceID":"52a158456bf94b52018e430e899d24d9"
    }
    ...
    if message_string:
        ...
        while (publish_count <= message_count) or (message_count == 0):
            ...
            message_json = json.dumps(developer_Dict)
            print(" after dumps...{} ".format(message_json))
